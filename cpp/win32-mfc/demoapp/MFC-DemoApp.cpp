...
// MFC-DemoApp.cpp : Defines the class behaviors for the application.
//
...
CDemoApp::CDemoApp() noexcept
{
	...
	SetAppID(_T("MFCDemoApp.AppID.NoVersion"));
...
BOOL CDemoApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CMFCDemoAppDoc),
		RUNTIME_CLASS(CMainFrame),       // main SDI frame window
		RUNTIME_CLASS(CMFCDemoAppView));
	if (!pDocTemplate)
		return FALSE;
	...
	{
		ic4::ErrorHandlerBehavior::Ignore,
		ic4::LogLevel::Warning,
		ic4::LogLevel::Error,
		ic4::LogTarget::WinDebug
	};
